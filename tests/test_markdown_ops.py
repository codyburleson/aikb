...
class TestMarkdownOps(unittest.TestCase):
    def setUp(self):
        ...
        # WAIT: The module uses a global VAULT_ROOT = os.path.abspath("./reference-vault")
        # We should probably respect that or temporarily change it if possible.
        # Given the code structure, it's safer to use the actual "./reference-vault" but 
        # use a dedicated test folder that we clean up.
